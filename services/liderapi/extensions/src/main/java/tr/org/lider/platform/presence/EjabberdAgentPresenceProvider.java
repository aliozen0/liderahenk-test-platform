...
@Component
public class EjabberdAgentPresenceProvider implements AgentPresenceProvider {

    private static final Logger logger = LoggerFactory.getLogger(EjabberdAgentPresenceProvider.class);
